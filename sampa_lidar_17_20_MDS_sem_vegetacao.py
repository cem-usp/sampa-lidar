...
def processo(scm):
    ...
    if len(glob.glob(f"{RESULT_FOLDER}/2020/MDS_sem_vegetacao/MDS-sem-vegetacao-{scm}-2020.tiff")) > 0 and len(glob.glob(f"{RESULT_FOLDER}/2017/MDS_sem_vegetacao/MDS-sem-vegetacao-{scm}-2017.tiff")) > 0:
